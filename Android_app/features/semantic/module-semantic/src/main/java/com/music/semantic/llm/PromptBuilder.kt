...
- scene_narrative: 用一句自然的话描述你感知到的场景和推荐理由，例如"雨夜独自驾驶，你看起来有些疲惫，适合安静的爵士乐配上暖色呼吸灯"
- announcement: 用口语化、有温度的方式告诉用户你的推荐逻辑，必须包含三个部分：①感知到了什么（环境/情绪/乘客等）②怎么推理的（为什么选这种风格）③推荐了什么（具体音乐风格和灯光氛围）。长度40-80字，用句号分隔。例如"夜深了，窗外下着小雨，你看起来有些疲惫。选了些爵士和氛围音乐帮你放松。车内灯光调成了暖色呼吸模式，陪你安静地开一段。"
