...
class SensorManager(private val context: Context) {
    ...
    fun getAudioMetrics(): MicData {
        ...
        if (read > 0) {
            ...
            Log.d("AudioMetrics", "RMS: $rms, AmpRMS: $amplifiedRms, Noise: $baselineNoiseLevel, AmpNoise: $amplifiedNoise, Thresh: $voiceThreshold, Voice: $hasVoice")
            ...
            Log.w("AudioMetrics", "Audio read failed or empty: $read")
        }
        return MicData()
    }
